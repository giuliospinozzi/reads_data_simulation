...
parser.add_argument('-d', '--db', dest="userdb_choice", action="store", help="DB to be used; accepted values: {local, alienware, cluster, nas}. Default: local", default='local')
...
elif args.userdb_choice == 'alienware':
	userdb = {
		'host': "172.25.39.2",
		'user': "andrea",
		'passwd': "andrea",
